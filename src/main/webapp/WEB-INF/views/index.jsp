		...
		<div class="logmod__wrapper">
			...
			<div class="logmod__container">
							...
							<form:form accept-charset="utf-8" action="register" modelAttribute="user" cssClass="simform">
								<div class="sminputs">
									<div class="input full">
										...
										<form:input cssClass="string optional" maxlength="255" path="email"
								...
								<div class="sminputs">
									<div class="input string optional">
										<label class="string optional" for="user-pw">Password
											*</label> <form:input cssClass="string optional" maxlength="255" path="password"
								...
								<div class="simform__actions">
									<form:button cssClass="sumbit" type="sumbit"
										 > Create Account </form:button> <span
				...
				<%-- 	<div class="logmod__tab lgm-2">
						...
						<div class="logmod__form">
							<form:form accept-charset="utf-8" modelAttribute="user" cssClass="simform">
								<div class="sminputs">
									<div class="input full">
										<form:label cssClass="string optional" path="user-name">Email*</form:label>
										<form:input cssClass="string optional" maxlength="255" path="email"
											placeholder="Email" type="email" size="50" />
									</div>
								</div>
								<div class="sminputs">
									<div class="input full">
										<form:label cssClass="string optional" path="user-pw">Password
											*</form:label> <form:input cssClass="string optional" maxlength="255" path="password"
											placeholder="Password" type="password" size="50" /> <span
											class="hide-password">Show</span>
									</div>
								</div>
								<div class="simform__actions">
									<form:button cssClass="sumbit" name="commit" type="sumbit"
